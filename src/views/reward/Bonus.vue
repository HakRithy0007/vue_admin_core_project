    ...
    <VCard class="w-full h-full pa-6 md:pa-8" elevation="0">
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <VCard v-for="(bonus, i) in bonusList" :key="i"
                ...
                <div class="pa-5">
                    <div class="mb-4">
                        <p class="text-xs text-info uppercase tracking-wide mb-3">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between p-3 rounded-lg">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-md font-medium">{{ t('BASE_BET') }}</span>
                                </div>
                            ...
                            <div class="flex items-center justify-between p-3 rounded-lg">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-md font-medium">{{ t('BASE_BONUS') }}</span>
                                </div>
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between p-3 rounded-lg">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-md font-medium">{{ t('STEP_UNIT') }}</span>
                                </div>
                            ...
                            <div class="flex items-center justify-between p-3 rounded-lg">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-md font-medium">{{ t('STEP_BONUS') }}</span>
                                </div>
                    ...
                    <VBtn block color="primary" class="mt-5 !w-[200px] font-semibold" @click="openEditDialog(i)">
            ...
            <VCard elevation="8">
                ...
                <VCardText class="pa-6">
                    <VRow>
                        ...
                        <VCol cols="12" md="6">
                            <VTextField v-model.number="editForm.baseBet" :label="t('BASE_BET')" type="number"
                                variant="outlined" density="comfortable" color="primary" />
                        </VCol>

                        <VCol cols="12" md="6">
                            <VTextField v-model.number="editForm.baseBonus" :label="t('BASE_BONUS')" type="number"
                                variant="outlined" density="comfortable" color="primary" />
                        </VCol>

                        <VCol cols="12" md="6">
                            <VTextField v-model.number="editForm.stepUnit" :label="t('STEP_UNIT')" type="number"
                                variant="outlined" density="comfortable" color="primary" />
                        </VCol>

                        <VCol cols="12" md="6">
                            <VTextField v-model.number="editForm.stepBonus" :label="t('STEP_BONUS')" type="number"
                                variant="outlined" density="comfortable" color="primary" />
                        </VCol>
                    </VRow>
                </VCardText>
